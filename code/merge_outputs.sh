#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/freesurfer_stats/BHRC/fs-tabulate/output_ria#decf35be-9265-4cee-a75b-232f90f73ca9
cd /cbica/projects/RBC/freesurfer_stats/BHRC/fs-tabulate
